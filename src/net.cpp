...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Sperry " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"explorer.sperrytecnologia.com.br", "35.200.11.206"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Sperry is probably already running."), addrBind.ToString().c_str());
        else
